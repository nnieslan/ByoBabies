(function($) {
    ...
    var self = $.extend(this, {
      ...
      $.extend(self, {
        registerUser: constructPostAction('account/registerexternal', true, null, {
          src: 'logon',
          action: 'registered'
        }),
        ...
        promiseProfile: constructGetPromise('account/get', true, function(data) {
          window.localStorage.setItem("profile", JSON.stringify(data));
        }, {
          src: 'profile',
          action: 'loaded'
        }),
        promiseUserInfo: constructGetPromise('account/userinfo', true, function(
          data) {
